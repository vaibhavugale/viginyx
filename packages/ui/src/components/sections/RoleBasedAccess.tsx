...
export default function RoleBasedAccess() {
  ...
  return (
    <section
      ref={containerRef}
      className="w-full px-4 md:px-8 py-8 md:py-12 bg-white"
    >
      <div className="max-w-7xl mx-auto bg-[#F8F9FA] border border-black/[0.04] rounded-[48px] md:rounded-[64px] relative overflow-hidden p-8 md:p-12 lg:p-20 shadow-sm">
        ...
        <div className="reveal-header text-center max-w-3xl mx-auto mb-16 space-y-6 relative z-10">
          ...
          <p className="text-lg md:text-xl text-brand-4 leading-relaxed">
            Viginyx shows every stakeholder exactly what they need — and nothing
            they don't.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-start relative z-10 max-w-5xl mx-auto">
          ...
          <div className="flex flex-col gap-4 w-full">
            {roles.map((role, index) => (
              ...
              >
                <div
                  className={`w-12 h-12 rounded-xl flex items-center justify-center shrink-0 ${role.iconBg}`}
                >
                  {role.icon}
                </div>
                <div>
                  <h3 className="text-[15px] font-bold text-brand-1 leading-tight mb-1">
                    {role.title}
                  </h3>
                  <p className="text-[11px] font-semibold text-brand-5">
                    {role.subtitle}
                  </p>
                </div>
              </button>
          ...
          <div className="w-[300px] md:w-[340px] h-[600px] bg-brand-9 rounded-[40px] md:rounded-[48px] shadow-[0_20px_50px_-12px_rgba(0,40,85,0.15)] border-[10px] md:border-[12px] border-brand-1 relative overflow-hidden flex flex-col mx-auto lg:ml-auto">
            ...
            <div
              ref={displayRef}
              className="w-full h-full relative z-10 pt-[60px] px-4 pb-6 overflow-y-auto no-scrollbar flex flex-col items-center"
            >
    ...
    <div className="w-full flex flex-col gap-3 font-sans text-slate-900">
      ...
      <div className="px-2 pt-1 pb-0.5">
        ...
        <p className="text-[10px] text-slate-500 font-medium">
          Your daily check-in and health history.
        </p>
      </div>

      <div className="bg-white p-3 rounded-2xl border border-slate-200 shadow-sm">
        <p className="text-[10px] text-slate-500 mb-0.5 font-semibold uppercase tracking-wider">
          Good morning
        </p>
        <h4 className="text-sm font-bold text-slate-900">
          Rajesh, how are you feeling today?
        </h4>
      </div>
      ...
      <div className="bg-white p-3 rounded-2xl border border-slate-200 shadow-sm space-y-3">
        ...
        <div className="grid grid-cols-2 gap-2">
          <button className="bg-rose-50 hover:bg-rose-100 text-rose-600 border border-rose-200 py-2 rounded-xl text-xs font-bold transition-colors">
            Yes
          </button>
          <button className="bg-emerald-500 hover:bg-emerald-600 text-white py-2 rounded-xl text-xs font-bold shadow-md shadow-emerald-500/20 transition-colors">
            No
          </button>
        </div>
      </div>
      ...
      <div className="bg-white p-3 rounded-2xl border border-slate-200 shadow-sm flex items-center justify-between">
        <div>
          <p className="text-[9px] text-slate-500 uppercase tracking-wider font-bold mb-1.5">
            Adherence
          </p>
          <div className="flex gap-1">
            {[1, 2, 3].map((i) => (
              <div
                key={i}
                className="w-5 h-5 rounded-full bg-emerald-50 border border-emerald-200 flex items-center justify-center"
              >
        ...
        <div className="text-right">
          <div className="text-[9px] text-brand-5 uppercase tracking-wider font-bold mb-0.5">
            Check-in
          </div>
          <div className="text-base font-black text-brand-8">
            3 <span className="text-[10px] text-brand-5">/ 6</span>
          </div>
        </div>
      </div>

      <div className="bg-brand-8/5 p-3 rounded-2xl border border-brand-8/20 mt-1">
        <h4 className="text-xs font-bold text-brand-1 mb-1 flex items-center gap-1.5">
          <ShieldAlert className="w-3.5 h-3.5 text-brand-8" /> Why this matters
        </h4>
        <p className="text-[10px] text-brand-4 leading-relaxed font-medium">
          If you're ever in an emergency, this app speaks for you — your full
          reaction history is available instantly.
        </p>
      </div>
    </div>
  );
  ...
  return (
    <div className="w-full flex flex-col gap-2.5 font-sans text-slate-900">
      ...
      <div className="px-2 pt-1 pb-0.5">
        ...
        <p className="text-[10px] text-slate-500 font-medium">
          Monitor flagged patients and calculate causality.
        </p>
      </div>
      ...
      <div className="bg-white border border-rose-200 shadow-sm p-3 rounded-2xl flex justify-between items-center relative overflow-hidden">
        ...
        <span className="px-2 py-1 bg-rose-50 text-rose-600 text-[8px] font-bold rounded-lg flex items-center gap-1 uppercase tracking-wider border border-rose-100">
      ...
      <div className="bg-white border border-slate-200 shadow-sm p-3 rounded-2xl flex justify-between items-center">
        <div>
          ...
          <p className="text-[10px] text-slate-500 font-medium mt-0.5">
            Metformin • Stable vitals
          </p>
        </div>
        <span className="px-2 py-1 bg-emerald-50 text-emerald-600 border border-emerald-100 text-[8px] font-bold rounded-lg uppercase tracking-wider">
          Stable
        </span>
      </div>
      ...
      <div className="bg-white border border-brand-8/20 shadow-sm p-3 rounded-2xl mt-1">
        <div className="flex justify-between items-end mb-2.5">
          <p className="text-[9px] uppercase tracking-wider font-bold text-brand-5">
            Naranjo Score
          </p>
          <p className="text-xs font-black text-brand-1">
            7 — <span className="text-brand-8">Probable ADR</span>
          </p>
        </div>
        ...
        <div className="flex flex-col gap-1.5">
          <div className="px-2 py-1.5 bg-brand-8/10 text-brand-8 border border-brand-8/20 text-[10px] font-bold rounded-lg text-center">
            WHO-UMC: Probable
          </div>
          <div className="px-2 py-1.5 bg-brand-9 text-brand-5 border border-brand-5/20 text-[10px] font-bold rounded-lg text-center">
            12 entries cross-verified
          </div>
        </div>
      </div>
  ...
  return (
    <div className="w-full flex flex-col gap-3 font-sans text-slate-900">
      ...
      <div className="px-2 pt-1 pb-0.5">
        ...
        <p className="text-[10px] text-slate-500 font-medium">
          Real-time audit trails and KPI tracking.
        </p>
      </div>
      ...
      <div className="bg-white border border-emerald-200 shadow-sm p-3 rounded-2xl flex justify-between items-center">
        <div>
          <p className="text-[8px] text-emerald-600 uppercase tracking-widest font-bold mb-1">
            NABH MOM.B.c Compliance
          </p>
      ...
      <div className="grid grid-cols-3 gap-2">
        <div className="bg-white border border-slate-200 shadow-sm p-2.5 rounded-2xl text-center">
          ...
          <p className="text-[7px] text-slate-500 uppercase tracking-wider font-bold">
            ADRs
          </p>
        </div>
        <div className="bg-white border border-slate-200 shadow-sm p-2.5 rounded-2xl text-center">
      ...
      <div className="bg-white border border-slate-200 shadow-sm p-3 rounded-2xl">
        <h4 className="text-[9px] uppercase tracking-widest font-bold text-slate-400 mb-2.5">
          Recent Activity
        </h4>
          ...
          {[
            ...
            >
              ...
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-[8px] text-emerald-600 bg-emerald-50 px-1 py-0.5 rounded font-bold flex items-center gap-0.5">
