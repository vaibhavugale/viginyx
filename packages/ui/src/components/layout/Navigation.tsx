  ...
  return (
    <header className="max-w-7xl mx-auto w-full flex items-center justify-between px-8 py-6">
      <div className="flex items-center gap-2">
        ...
        <h1 className="text-xl font-bold tracking-tight text-brand-1">
          VIGINYX
        </h1>
      </div>
      <nav className="hidden md:flex items-center gap-8">
        {["Product", "Security", "NABH", "Pricing"].map((item) => (
          <a
            ...
            className="text-sm font-bold text-brand-3 hover:text-brand-1 transition-colors"
          >
            {item}
          </a>
        ))}
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24 mb-20">
          ...
          <div className="lg:col-span-5 space-y-8">
            <h2 className="text-3xl font-bold tracking-tight text-brand-1 font-serif italic">
              Viginyx
            </h2>
            <p className="text-sm md:text-base text-brand-4 leading-relaxed max-w-sm">
              Precision Pharmacovigilance Intelligence for Modern Indian
              Hospitals. Built for NABH compliance, powered by AI, secured by
              blockchain.
            </p>
            <div className="flex items-center gap-3 text-brand-8">
              ...
              <span className="text-[11px] md:text-xs font-medium text-brand-5">
                Incubated at RIIDL, Somaiya Vidyavihar University, Mumbai
              </span>
            </div>
          </div>
          ...
          <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-12">
            ...
            <div className="space-y-6">
              <h4 className="text-[10px] font-black text-brand-5 uppercase tracking-[0.2em]">
                Platform
              </h4>
              <ul className="space-y-4">
                {[
                  ...
                  <li key={link}>
                    <a
                      href="#"
                      className="text-[13px] font-bold text-brand-3 hover:text-brand-8 transition-colors"
                    >
                      {link}
                    </a>
                  </li>
        ...
        <div className="pt-10 border-t border-brand-5/10 flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex items-center gap-3">
            ...
            <span className="text-[10px] md:text-xs font-black text-brand-5 uppercase tracking-widest">
          ...
          <div className="flex items-center gap-3">
            ...
            <a
              href="mailto:helloviginyx@gmail.com"
              className="text-[13px] font-bold text-brand-3 hover:text-brand-1 transition-colors tracking-tight"
            >
